...
for (i in 1:5){
    ...
    prior.delta = c(-30, 1),  prior.eta = list(rep(0, length(Dare$node)+2), diag(length(Dare$node)+2)), prior.tau = c(0.5, 0.5),
    Outer = 3, Inner = c(22000,5500, 1100), burn = c(2000,500, 100), thin = c(20,5,1), 
