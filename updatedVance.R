...
logWZ <- function(nIP, K, textlist2, W, currentC, currentZ, alpha, mvec, delta, nvec){
...
unix.time(VanceMCMC<- MCMC(edge, node, textlist, vocabulary, 2, 10, 0.5, outer=1, n1=3, n2=3, n3=3300, burn=300, thin=3, opt=TRUE, seed=5))
save(VanceMCMC, file="VanceMCMC_asym5.RData")
