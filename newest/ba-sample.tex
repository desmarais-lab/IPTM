...
\begin{equation}
c_d\sim \mbox{Categorical}(\frac{\psi_1}{\sum_c \psi_c},\ldots,\frac{\psi_C}{\sum_c \psi_c}),
\end{equation}
and we assume the interaction-pattern specific weights from Gamma distribution
\begin{equation}
\psi_c\sim \Gamma(\frac{\gamma_0}{C}, \zeta),
\end{equation}
...
The generative process for network portion of the documents---the senders, receivers, and timestamps---exactly follows that of the hyperedge event model (HEM).
