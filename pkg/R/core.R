...
#' @param mu parameter of speed at which sender replies, with larger values indicating faster response time
...
#'
#' @export
GenerateDocs = function(nDocs, betas, gammas, node, vocabulary, alpha, mvec, beta, nvec, mu, delta = 1,
