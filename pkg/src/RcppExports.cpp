...
RcppExport SEXP IPTM_rbinom_mat(SEXP probijSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type probij(probijSEXP);
    rcpp_result_gen = Rcpp::wrap(rbinom_mat(probij));
    return rcpp_result_gen;
END_RCPP
}
// History
...
RcppExport SEXP IPTM_Triadic2(SEXP triadicSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List >::type triadic(triadicSEXP);
    rcpp_result_gen = Rcpp::wrap(Triadic2(triadic));
    return rcpp_result_gen;
END_RCPP
}
// MultiplyXB
...
RcppExport SEXP IPTM_TimeInEqZ(SEXP LambdaiJiSEXP, SEXP tdiffSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type LambdaiJi(LambdaiJiSEXP);
    Rcpp::traits::input_parameter< double >::type tdiff(tdiffSEXP);
    rcpp_result_gen = Rcpp::wrap(TimeInEqZ(LambdaiJi, tdiff));
    return rcpp_result_gen;
END_RCPP
}
// ObservedInEqZ
double ObservedInEqZ(NumericVector LambdaiJi, double observediJi);
RcppExport SEXP IPTM_ObservedInEqZ(SEXP LambdaiJiSEXP, SEXP observediJiSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type LambdaiJi(LambdaiJiSEXP);
    Rcpp::traits::input_parameter< double >::type observediJi(observediJiSEXP);
    rcpp_result_gen = Rcpp::wrap(ObservedInEqZ(LambdaiJi, observediJi));
    return rcpp_result_gen;
END_RCPP
}
// lambdaiJi
