...
unix.time(DareMCMC<- MCMC(edge, node, textlist, vocabulary, 3, 10, 0.02, outer=150, n1=1, n2=1, n3=3300, burn=300, thin=3, opt=TRUE, seed=3))
save(DareMCMC, file="DareMCMC_asym3.RData")
