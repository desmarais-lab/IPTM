...
\vspace{-1.5cm}
\includegraphics[scale=.475, left]{./figures/Schein_C_50k.pdf} \\  \vspace{-6cm} \includegraphics[height=4cm, right]{./figures/ScheinFocus}

\end{frame}

\begin{frame} \frametitle{GiR: Results with fixed C}
 \vspace{-1.5cm}
\includegraphics[scale=.475, left]{./figures/Schein_NoC_50k.pdf} \\  \vspace{-6cm} \includegraphics[height=4cm, right]{./figures/ScheinFocusNoC}
\end{frame}
...
\begin{frame}{IPTM Result: Dynamic Network Effects, Dare County}
	...
	\begin{figure}
		\includegraphics[width=.5\textwidth]{figures/DareBReceive-1.png} \includegraphics[width=.5\textwidth]{figures/Dare2Receive-1.png}
	\end{figure}	
\end{frame}
