...
\end{frame}
 ...
 \centering
  	...
  	\scalebox{0.75}{	 	\begin{tabular}{ |c||c|c|c|c|c|}  
  			...
  			\textbf{Word}
  			& time & survey &  road & library & \cellcolor{blue!25} status \\
  			& hours & voice & mirlo & week & \cellcolor{blue!25} system \\
  			& leave & copy&\cellcolor{blue!25}  storm &  working & area \\
  			& monday & discovery & beach & place & south \\
  			& administrative & regional & high & best & \cellcolor{blue!25} forecast \\
  			& employees & parties & \cellcolor{blue!25} coastal & start & \cellcolor{blue!25} track \\
  			& empoyee & disclosed & \cellcolor{blue!25}  impacts & visit & pay \\
  			& work & elections & saturday & year & move \\
  			& day & pin & dot & albemarle & assessment \\
  			& friday & sending & night & librarian & opens \\
  			& october & prior & \cellcolor{blue!25} winds & web & \cellcolor{blue!25} damage\\
  			& \cellcolor{blue!25} storm &editor & hold & learning & well\\
  			& tomorrow & students & \cellcolor{blue!25} bridge & east&\cellcolor{blue!25}  ocean\\
