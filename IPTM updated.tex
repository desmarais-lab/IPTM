...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.59\textwidth]{logprob.pdf} 
		\includegraphics[width=0.4\textwidth]{alpha.pdf} 
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.55\textwidth]{topics.pdf} 
		\includegraphics[width=0.65\textwidth]{topic.pdf} 
	\caption{Posterior distribution of  $\mathcal{Z}$ for Vance county emails}
	\label{fig:Vancebarplot}
\end{figure}
\footnotesize
