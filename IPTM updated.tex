...
\prod_{d=1}^D\Big(\mbox{exp}\Big\{{-(t^{(d)}-t^{(d-1)})\sum\limits_{i \in \mathcal{A}^{(c)}}\sum\limits_{j\in \mathcal{A}^{(c)}}\lambda_{ij}^{(c)}(t^{(d)})}\Big\}\cdot \prod_{i \in \mathcal{A}^{(c)}}\prod_{j\in \mathcal{A}^{(c)}}\frac{\Big(\lambda_{ij}^{(c)}(t^{(d)})\cdot(t^{(d)}-t^{(d-1)})\Big)^{n_d^{(ij)}}}{n_d^{(ij)}!}\Big).
\end{equation}
...
\begin{equation}
\begin{aligned} 
&\mbox{log}(P(\mathcal{B'}))-\mbox{log}(P(\mathcal{B}))+\Big(\boldsymbol{\beta'}^{(c^{(d)})T}-\boldsymbol{\beta}^{(c^{(d)})T}\Big)\boldsymbol{x}^*_{t^{(d)}}(i^{(d)}, j^{(d)})\\&-\sum_{d=1}^D\Big((t^{(d)}-t^{(d-1)})\Big(\sum\limits_{i \in A^{(c^{(d)})}}\sum\limits_{j\in \mathcal{A}^{(c^{(d)})}}\Big(\mbox{exp}\Big\{\boldsymbol{\beta'}^{(c^{(d)})T}\boldsymbol{x}^*_{t^{(d)}}(i, j)\Big\}-\mbox{exp}\Big\{\boldsymbol{\beta}^{(c^{(d)})T}\boldsymbol{x}^*_{t^{(d)}}(i, j)\Big\}\Big)
\end{aligned}
\end{equation}
