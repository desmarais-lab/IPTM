      ...
      \subsection{Details on Document Prediction Experiments}\label{subsec:Details on PPE}    
       ...
       \end{algorithm}
          ...
          \end{algorithm}        
          	...
          	\includegraphics[width=1\textwidth]{plots/MI4.pdf}  
               ...
               \begin{figure}[ht]
               	...
               	\includegraphics[width=1\textwidth]{plots/weekdays.pdf}
               	           	           	\includegraphics[width=1\textwidth]{plots/timeplot.pdf}    
           ...
           \begin{figure}[ht]
           	\centering
           	           	           	\includegraphics[width=1\textwidth]{plots/logLsurvreg.pdf}
           	\includegraphics[width=1\textwidth]{plots/survregplot.pdf}  
           	\label{fig:timeplot}
           \end{figure}
