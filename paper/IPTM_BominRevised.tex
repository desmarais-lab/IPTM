...
\textbf{Note: Plots and analysis to be updated when we get the results}
\begin{figure}[ht]
	\centering
	\includegraphics[width=1\textwidth]{plots/PPC_Dare_2_10.pdf}  
	\label{fig:DarePPC}
	\caption{PPC results for Dare County data: (a) outdegree distribution, (b) indegree distribution, (c) multicast distribution, and (d) QQplot of time-increments}
\end{figure}
