...
Daretest <- IPTM_inference.data(Dare$edge, Dare$node, Dare$text, Dare$vocab, nIP = 2, K = 20, sigma_Q = c(0.0005, 0.01),
                       ...
                       prior.b.var = 1 * diag(25), prior.delta = c(0, 1), out = 1, n_B = 5500, n_d = 1500, burn = c(500,500), thinning = c(10,5), netstat = c("intercept", "dyadic", "degree", "triadic"), plot = FALSE, optimize = FALSE)
