...
Vancetest <- IPTM_inference.Gibbs(Vance$edge, Vance$node, Vance$text, Vance$vocab, nIP = 2, K = 5, sigma_Q = c(0.05, 1),
                       ...
                       thinning = 5, netstat = c("degree", "dyadic"), plot = TRUE, optimize = TRUE)
