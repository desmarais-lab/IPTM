...
load('~/Desktop/IPTM/paper/code/HPC/topic coherence/tDaretest_IPTM_K50.RData')
top.words = TableWord(Daretest$Z, 50, Dare$text, Dare$vocab)
topic.word = matrix(0, nrow = length(Daretest$Z), ncol = length(Dare$vocab))
rownames(topic.word) = 1:length(Dare$text)
colnames(topic.word) = Dare$vocab
...
load('~/Desktop/IPTM/paper/code/HPC/topic coherence/tDaretest_IPTM_K40.RData')
top.words = TableWord(Daretest$Z, 40, Dare$text, Dare$vocab)
topic.word = matrix(0, nrow = length(Daretest$Z), ncol = length(Dare$vocab))
rownames(topic.word) = 1:length(Dare$text)
colnames(topic.word) = Dare$vocab
...
load('~/Desktop/IPTM/paper/code/HPC/topic coherence/tDaretest_IPTM_K30.RData')
top.words = TableWord(Daretest$Z, 30, Dare$text, Dare$vocab)
topic.word = matrix(0, nrow = length(Daretest$Z), ncol = length(Dare$vocab))
rownames(topic.word) = 1:length(Dare$text)
colnames(topic.word) = Dare$vocab
...
load('~/Desktop/IPTM/paper/code/HPC/topic coherence/tDaretest_IPTM_K20.RData')
top.words = TableWord(Daretest$Z, 20, Dare$text, Dare$vocab)
topic.word = matrix(0, nrow = length(Daretest$Z), ncol = length(Dare$vocab))
rownames(topic.word) = 1:length(Dare$text)
colnames(topic.word) = Dare$vocab
...
load('~/Desktop/IPTM/paper/code/HPC/topic coherence/tDaretest_IPTM_K10.RData')
top.words = TableWord(Daretest$Z, 10, Dare$text, Dare$vocab)
topic.word = matrix(0, nrow = length(Daretest$Z), ncol = length(Dare$vocab))
rownames(topic.word) = 1:length(Dare$text)
colnames(topic.word) = Dare$vocab
...
load('~/Desktop/IPTM/paper/code/HPC/topic coherence/tDaretest_IPTM_K5.RData')
top.words = TableWord(Daretest$Z, 5, Dare$text, Dare$vocab)
topic.word = matrix(0, nrow = length(Daretest$Z), ncol = length(Dare$vocab))
rownames(topic.word) = 1:length(Dare$text)
colnames(topic.word) = Dare$vocab
...
load('~/Desktop/IPTM/paper/code/HPC/topic coherence/tDaretest_IPTM_K2.RData')
top.words = TableWord(Daretest$Z, 2, Dare$text, Dare$vocab)
topic.word = matrix(0, nrow = length(Daretest$Z), ncol = length(Dare$vocab))
rownames(topic.word) = 1:length(Dare$text)
colnames(topic.word) = Dare$vocab
...
K = 1
Dare_topic[3,1] = mean(sapply(1:K, function(k) {
    topic_coherence(top.words[,k], topic.word,Dare$vocab)
}))
...
K =50
Dare_topic[5,8] = mean(sapply(1:K, function(k) {
    topic_coherence(top.words[,k], topic.word,Dare$vocab)
}))
...
K =40
Dare_topic[5,7] = mean(sapply(1:K, function(k) {
    topic_coherence(top.words[,k], topic.word,Dare$vocab)
}))
...
K =30
Dare_topic[5,6] = mean(sapply(1:K, function(k) {
    topic_coherence(top.words[,k], topic.word,Dare$vocab)
}))
...
K =20
Dare_topic[5,5] = mean(sapply(1:K, function(k) {
    topic_coherence(top.words[,k], topic.word,Dare$vocab)
}))
...
K = 10
Dare_topic[5,4] = mean(sapply(1:K, function(k) {
    topic_coherence(top.words[,k], topic.word,Dare$vocab)
}))
...
K = 5
Dare_topic[5,3] = mean(sapply(1:K, function(k) {
    topic_coherence(top.words[,k], topic.word,Dare$vocab)
}))
...
K = 2
Dare_topic[5,2] = mean(sapply(1:K, function(k) {
    topic_coherence(top.words[,k], topic.word,Dare$vocab)
}))

Dare_topic[5,1] = Dare_topic[1,1]




load('~/Desktop/IPTM/paper/code/HPC/topic coherence/tDaretest_LDA_K50.RData')
Daretest = Daretest_LDA
top.words = TableWord(Daretest$Z, 50, Dare$text, Dare$vocab)
topic.word = matrix(0, nrow = length(Daretest$Z), ncol = length(Dare$vocab))
rownames(topic.word) = 1:length(Dare$text)
...
K =50
Dare_topic[6,8] = mean(sapply(1:K, function(k) {
    topic_coherence(top.words[,k], topic.word,Dare$vocab)
}))

load('~/Desktop/IPTM/paper/code/HPC/topic coherence/tDaretest_LDA_K40.RData')
Daretest = Daretest_LDA
top.words = TableWord(Daretest$Z, 40, Dare$text, Dare$vocab)
topic.word = matrix(0, nrow = length(Daretest$Z), ncol = length(Dare$vocab))
rownames(topic.word) = 1:length(Dare$text)
...
K =40
Dare_topic[6,7] = mean(sapply(1:K, function(k) {
    topic_coherence(top.words[,k], topic.word,Dare$vocab)
}))

load('~/Desktop/IPTM/paper/code/HPC/topic coherence/tDaretest_LDA_K30.RData')
Daretest = Daretest_LDA
top.words = TableWord(Daretest$Z, 30, Dare$text, Dare$vocab)
topic.word = matrix(0, nrow = length(Daretest$Z), ncol = length(Dare$vocab))
rownames(topic.word) = 1:length(Dare$text)
...
K =30
Dare_topic[6,6] = mean(sapply(1:K, function(k) {
    topic_coherence(top.words[,k], topic.word,Dare$vocab)
}))
...
K =20
Dare_topic[6,5] = mean(sapply(1:K, function(k) {
    topic_coherence(top.words[,k], topic.word,Dare$vocab)
}))


load('~/Desktop/IPTM/paper/code/HPC/topic coherence/tDaretest_LDA_K10.RData')
Daretest = Daretest_LDA
top.words = TableWord(Daretest$Z, 10, Dare$text, Dare$vocab)
topic.word = matrix(0, nrow = length(Daretest$Z), ncol = length(Dare$vocab))
rownames(topic.word) = 1:length(Dare$text)
...
K = 10
Dare_topic[6,4] = mean(sapply(1:K, function(k) {
    topic_coherence(top.words[,k], topic.word,Dare$vocab)
}))



load('~/Desktop/IPTM/paper/code/HPC/topic coherence/tDaretest_LDA_K5.RData')
Daretest = Daretest_LDA
top.words = TableWord(Daretest$Z, 5, Dare$text, Dare$vocab)
topic.word = matrix(0, nrow = length(Daretest$Z), ncol = length(Dare$vocab))
rownames(topic.word) = 1:length(Dare$text)
...
K = 5
Dare_topic[6,3] = mean(sapply(1:K, function(k) {
    topic_coherence(top.words[,k], topic.word,Dare$vocab)
}))


load('~/Desktop/IPTM/paper/code/HPC/topic coherence/tDaretest_LDA_K2.RData')
Daretest = Daretest_LDA
top.words = TableWord(Daretest$Z, 2, Dare$text, Dare$vocab)
topic.word = matrix(0, nrow = length(Daretest$Z), ncol = length(Dare$vocab))
rownames(topic.word) = 1:length(Dare$text)
...
K = 2
Dare_topic[6,2] = mean(sapply(1:K, function(k) {
    topic_coherence(top.words[,k], topic.word,Dare$vocab)
}))

Dare_topic[6,1] = Dare_topic[1,1]
...
plot(colnames(Dare_topic), colMeans(Dare_topic[4:6,]), type = 'l', col = 'red', xlab = "Number of Topics", lty = 2, ylab = "Topic Coherence", ylim = c(min(Dare_topic), -400))
lines(colnames(Dare_topic), colMeans(Dare_topic[1:3,]), lty = 3,col = "blue")
