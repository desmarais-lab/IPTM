...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.49\textwidth]{plots/convergence.pdf} 
	\end{figure}
\begin{figure}[H]
	\centering	
		\includegraphics[width = 0.49\textwidth]{plots/beta.jpeg} 
		\includegraphics[width = 0.49\textwidth]{plots/eta1.jpeg} 
		\includegraphics[width = 0.49\textwidth]{plots/deltasigma.jpeg} 
	\end{figure}		
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
