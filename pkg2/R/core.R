...
data = GenerateDocs(400, 1:4, vocabulary, 2, 4, 4, 2, rep(1/4, 4), 2, rep(1/4, 4), "dyadic", 13)
inference = MCMC(data$edge, 1:4, data$text, vocabulary, 2, 4, 0.15, 10, 3, 3, 3300, 300, 30, "dyadic", 2, TRUE)
