...
Daretest <- IPTM_inference.Network(Dare$edge, Dare$node, Dare$text, Dare$vocab, nIP = 1, K = 1, sigma_Q = c(0.0005, 0.01),
                        alpha = 2, mvec = rep(1/1, 1), betas = 2, nvec = rep(1/length(Dare$vocab), length(Dare$vocab)), 
